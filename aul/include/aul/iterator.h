...
iterator_t iterator_new(const char * clazz, itrnext_f next_func, itrfree_f free_func, const void * object, void * itrobject);
//const void * iterator_getobject(iterator_t itr, const char * class);
const void * iterator_next(iterator_t itr, const char * clazz);
