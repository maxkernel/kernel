...
#define MODEL_SIZE_NAME					MMAX(MMAX(META_SIZE_ANNOTATE, META_SIZE_FUNCTION), MMAX(META_SIZE_VARIABLE, META_SIZE_BLOCKNAME))
...
#define MODEL_SIZE_MAX \
	(MMAX(MODEL_SIZE_PATH,			\
	 MMAX(MODEL_SIZE_NAME,			\
	 MMAX(MODEL_SIZE_DESCRIPTION,	\
	 MMAX(MODEL_SIZE_VALUE,			\
